...
# ================================================================================
# ================================================================================
# - Purpose: This file contains all bash aliases used for creatig new Bash
...
alias create_py_test='bash ~/.config/bash_scripts/create_file.sh Python_Test'     # Create a Python test file
alias open_py_ide='bash ~/.config/bash_scripts/create_project_tmux.sh Python'  # Open a tmux based ide
...
alias create_cpp_dir='bash ~/.config/bash_scripts/create_dir.sh C++' 
alias create_cpp_file='bash ~/.config/bash_scripts/create_file.sh C++'
